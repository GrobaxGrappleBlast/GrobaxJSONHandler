...
*/
export declare function JsonProperty(option?: JSONInnerPropertyOptions<any, any>): (target: any, propertyKey: string) => void;
/**
 ...
 */
export declare function JsonMapping<IN extends object, OUT extends object>(params: JsonMappingParameters<IN, OUT>): (target: any, propertyKey: string) => void;
 ...
 */
export declare function JsonMappingRecordInArrayOut<IN extends object, OUT extends object>(option: specialRecordArrayMappingProperties<IN, OUT>): (target: any, propertyKey: string) => void;
interface JsonObjectProperties {
    scheme?: string;
    onBeforeSerialization?: (self: any) => any;
    onAfterDeSerialization?: (self: any) => any;
}
export declare function JsonObject(option: JsonObjectProperties): (target: any) => void;
export {};
